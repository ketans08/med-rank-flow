...
const mockStudentTasks: PatientTask[] = [
  {
    ...
    description: 'Initial assessment and exercise prescription for post-MI patient',
  ...
  },
  {
    ...
    patient: { name: 'Mrs. Dorothy Evans', age: 78, primaryComplaint: 'Recent falls, balance issues' },
    assignedStudentId: '2',
    assignedStudentName: 'John Smith',
    status: 'pending',
  ...
  },
  {
    ...
    patient: { name: 'Alex Rodriguez', age: 19, primaryComplaint: 'ACL reconstruction recovery' },
    assignedStudentId: '2',
    assignedStudentName: 'John Smith',
    status: 'pending',
...
const StudentDashboard = () => {
  ...
  const getPatientComplexityColor = (age: number, complaint: string) => {
    if (age > 70 || complaint.toLowerCase().includes('cardiac') || complaint.toLowerCase().includes('post-op')) {
      return 'medical-red';
      ...
      <div className="container mx-auto px-4 py-6">
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">{tasks.filter(t => t.status === 'accepted').length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            {tasks.map((task) => (
              <Card key={task.id} className="transition-all duration-300 hover:shadow-lg">
                <CardHeader>
                  ...
                  <div className="p-4 rounded-lg bg-muted/50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">{task.patient.primaryComplaint}</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-3 flex items-center space-x-2">
                      ...
                      <div className={`w-3 h-3 rounded-full bg-${getPatientComplexityColor(task.patient.age, task.patient.primaryComplaint)}`}></div>
                      <span className="text-xs text-muted-foreground">
                        {task.patient.age > 70 ? 'High' : task.patient.age > 50 ? 'Medium' : 'Low'}
                      </span>
                    </div>
                    ...
                    {task.patient.notes && (
                      <div className="mt-3">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">{task.patient.notes}</p>
                      </div>
                    )}
                  </div>
